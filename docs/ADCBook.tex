...
{\centering \includegraphics[width=0.8\linewidth]{images/Client Data Model Example} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/Distributed Data Model Example} 
